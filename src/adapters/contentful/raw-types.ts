...
const rawItemsSchema = z.looseObject({
  type: z.string(),
  linkType: z.string().optional(),
  validations: z.array(validationSchema).optional(),
});

const rawFieldSchema = z.looseObject({
  id: z.string(),
  name: z.string(),
  type: z.string(),
  linkType: z.string().optional(),
...
export const rawContentTypeSchema = z.looseObject({
  sys: z.looseObject({ id: z.string(), createdAt: z.string().optional(), updatedAt: z.string().optional() }),
  name: z.string(),
...
export const rawLocaleSchema = z.looseObject({
  code: z.string(),
